...
def TotalGain(the_data, coding):
    ...
    saved_data.original_length=beforeCompression
    saved_data.compressed_length=afterCompression
...
def HuffmanEncoding(the_data):
    ...
    saved_data.codes_dict=huffmanEncoding
...
class Save_Data:
    ...
    def get_characters_and_codes(self):
...
def initialize(text):
    ...
    #saved data object
    print("Save data object")
    print(saved_data.codes_dict)
    print(saved_data.original_length)
    print((saved_data.compressed_length))
